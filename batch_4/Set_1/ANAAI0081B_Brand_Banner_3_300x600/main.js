...
function animate() {
  ...
  tl1.to(".photo", 0.4, {transform: 'translate(0px, -128px)', ease: "power1.out",}, "<");
  tl1.to([".star1", ".star2", ".star3"], {y: -124.6708, ease: "power1.out", stagger: 0.05}, "<");
  tl1.to(".card", 0.5, {y:-126, ease: "power1.out", stagger: 0.05}, "<+0.02");
