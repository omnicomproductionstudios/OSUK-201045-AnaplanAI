...
function animate() {
  ...
  tl1.to(['#bg-1-icon'], 0.5,{ scale: 56, rotation: 0.1, ease: "power1.in" }, 1);
  ...
  tl1.to(['#text-1c'], 0.5,{ autoAlpha: 1 }, '<');
  tl1.to(['#text-1c'], 0.5,{ autoAlpha: 0 }, '+=0');

  tl1.to(['#logo-1'], 0,{ autoAlpha: 0 }, '+=1');
  tl1.to(['#frame-1'], 0.5,{ scale: 200, rotation: 0.1, ease: "power1.in" }, '+=0');
  tl1.to(['#frame-1'], 0,{autoAlpha: 0 }, '+=0');

  tl1.from(split3.chars, 0.1, { y: -20, autoAlpha: 0, stagger: 0.05,}, '+=0');

  tl1.to(['#logo-2'], 0,{ autoAlpha: 0 }, '+=1');
  tl1.to(['#frame-2'], 0.5,{ scale: 200, rotation: 0.1, ease: "power1.in" }, '+=0');
